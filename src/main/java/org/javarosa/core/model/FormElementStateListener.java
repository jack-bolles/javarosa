...
public interface FormElementStateListener {
    int CHANGE_INIT = 0x00;
    int CHANGE_DATA = 0x01;
    int CHANGE_LOCALE = 0x02;
    int CHANGE_ENABLED = 0x04;
    int CHANGE_RELEVANT = 0x08;
    int CHANGE_REQUIRED = 0x10;
//    static final int CHANGE_LOCKED = 0x20;
int CHANGE_OTHER = 0x40;
